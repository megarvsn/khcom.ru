	 ...
	 --><div class="elementNews" id="<?=$this->GetEditAreaId($arItem["ID"]);?>">
			...
			<div class="allText">
				<?if(!empty($arItem["DISPLAY_ACTIVE_FROM"])){?>
					<div class="title">
						<?if(!empty($arItem["DISPLAY_ACTIVE_FROM"])){?>
							<div class="shareDate"><?=GetMessage("NS_DATE_ACTIVE_FROM");?> <?=$arItem["DISPLAY_ACTIVE_FROM"];?></div>
						<?}?>
						<?if(!empty($arItem["DISPLAY_DATE_ACTIVE_TO"])){?>
							<div class="shareDate"> <?=GetMessage("NS_DATE_ACTIVE_TO");?> <?=$arItem["DISPLAY_DATE_ACTIVE_TO"];?></div>
						<?}?>
					</div>
				<?}?>
