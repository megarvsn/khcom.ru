...
<div class="mainTitle">
    <h1><span class="bg-color-4"><?= $arParams["PAGER_TITLE"] ?>&nbsp;</span><span
                class="bg-color-1">&nbsp;&nbsp;</span></h1>
</div>
<div class="workArea">
    <div class="company mt--50">
        <? $APPLICATION->IncludeFile(SITE_DIR . "services/text.php.inc", array(), array("MODE" => "html", "NAME" => "Текст")); ?>
    </div>
