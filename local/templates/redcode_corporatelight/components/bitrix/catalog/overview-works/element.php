...
$isSidebarLeft = isset($arParams['SIDEBAR_SECTION_POSITION']) && $arParams['SIDEBAR_SECTION_POSITION'] === 'left';
		...
		$elementId = $APPLICATION->IncludeComponent('bitrix:catalog.element', 'overview-works', $componentElementParams,
			$component
		);
				...
				if (!empty($recommendedData['IBLOCK_LINK']) || !empty($recommendedData['ALL_LINK']))
				{
					...
					<div class="row mb-5">
						<div class="col" data-entity="parent-container">
							...
							<?
							$APPLICATION->IncludeComponent('bitrix:catalog.recommended.products', 'overview-works', array(
									'ID' => $elementId,
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
				...
				if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
				{
					...
					<div class="row mb-5">
						<div class="col" data-entity="parent-container">
							...
							<? $APPLICATION->IncludeComponent('bitrix:catalog.section', 'overview-works', array(
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
									'SECTION_ID' => $arResult['VARIABLES']['SECTION_ID'],
									'SECTION_CODE' => $arResult['VARIABLES']['SECTION_CODE'],
				...
				)
				{
					...
					<div class="row mb-5">
						<div class="col" data-entity="parent-container">
							...
							<? $APPLICATION->IncludeComponent('bitrix:catalog.products.viewed', 'overview-works', array(
									'IBLOCK_MODE' => 'single',
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
									'ELEMENT_SORT_FIELD' => $arParams['ELEMENT_SORT_FIELD'],
